...
class ElevenLabsService:
    def __init__(self):
        ...
        self.voice_profiles = {
            'default': 'Rachel',  # Warm, clear female voice
            'friendly': 'Josh',   # Friendly male voice
            'professional': 'Bella',  # Professional female voice
            'energetic': 'Antoni',  # Energetic male voice
            'calm': 'Elli'  # Calm, soothing female voice
        }
    ...
    def text_to_speech(self, text, voice_id='default', settings=None):
        ...
        try:
            # Map voice_id to actual voice name
            voice_name = self.voice_profiles.get(voice_id, 'Rachel')
